...
static unsigned int c62dTbl[NR_FREQ * NR_MT_CPU_DVFS][ARRAY_COL_SIZE] = {
	/* Freq, Vproc, post_div, clk_div */
	{ 1801, 96, 1, 1 },     /* L */
	{ 1793, 88, 1, 1 },
	{ 1786, 81, 1, 1 },
...
static unsigned int c62dlyTbl[NR_FREQ * NR_MT_CPU_DVFS][ARRAY_COL_SIZE] = {
	/* Freq, Vproc, post_div, clk_div */
	{ 1801, 96, 1, 1 },     /* L */
	{ 1793, 90, 1, 1 },
	{ 1786, 84, 1, 1 },
...
unsigned int *xrecordTbl[NUM_CPU_LEVEL] = {	/* v1.2 */
	...
	[CPU_LEVEL_6] = &c65rTbl[0][0],
	[CPU_LEVEL_7] = &c62dTbl[0][0],
	[CPU_LEVEL_8] = &c62dlyTbl[0][0],
};
